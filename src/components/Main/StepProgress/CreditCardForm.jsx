      ...
      <section className="form-body col col-12">
        <div className="col col-12">
          <PaymentInfo 
            ...
            name='cardHolder' onChange={handleInputValue}
            />
        </div>
        <div className="col col-12">
          <PaymentInfo 
            className="input-group input-w-lg-4 input-w-sm-full"
            inputLabel="卡號" type="text" placeholder="1111 2222 3333 4444" name='cardNumber' onChange={handleInputValue}
            />
        </div>
        <div className="col col-12">
          <PaymentInfo 
            ...
            name='expireDate' onChange={handleInputValue}
            />
          <PaymentInfo 
            className="input-group input-w-lg-3 input-w-sm-s3"
            inputLabel="CVC / CCV" type="text" placeholder="123"
            name='cvc' onChange={handleInputValue}
            />
        </div>
      </section>
    </form>
...
function PaymentInfo ({className, inputLabel, text, placeholder, name, onChange}) {
  return (
